 ...
 * ModuleShapeExpr is a module-invocation lowered typestate, distinct from TIR
 * Shape/DimExpr; generic shape-expression lowering is intentionally unsupported.
 */
#pragma once
...
private:
    ...
    struct Node;
    /*! Fail closed when bounded expression arithmetic can overflow or divide by zero. */
...
public:
    ...
    /*! True only when this contract is fully static against the physical ABI. */
